<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"../application/index/tpl/dmstay\index.html";i:1548765601;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\header.html";i:1548765601;s:69:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\menu.html";i:1548765601;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\footer.html";i:1548765601;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
        ...
        <div class='search-box'>
          <div class="ipt-box">
              <form  action="<?php echo url('dmstay/index'); ?>" method='post'>
                  <input placeholder="请输入学生姓名"  name="name" value="<?php echo $name; ?>" class='search-ipt' type="text">
        ...
        <div style='margin-top:20px;' class='clearfix'>
                <div style='margin-bottom:20px;' class='nav-tab-box p-l'>
                    <span class='tab-item on'><a  href="<?php echo url('dmstay/index'); ?>">人员信息</a></span>
                </div>
                <div class='p-r'>
                    <form id="search_from" action="<?php echo url('dmstay/index'); ?>" method='post'>
                        <input placeholder="学号" name="student_num" class="ipt ipt-xs" value="<?php echo $student_num; ?>">
                        ...
                        <select style='margin:0 10px;' class='ipt-xs' name="dormitory_id">
                            <option value="">请选择</option>
                            <?php if(!empty($floor_id) || !empty($dormitory_id)): if(is_array($dormitory) || $dormitory instanceof \think\Collection || $dormitory instanceof \think\Paginator): $i = 0; $__LIST__ = $dormitory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;if($floor_id == $val['floor_id']): ?>
                            <option value="<?php echo $val['id']; ?>" <?php if($val['id'] ==$dormitory_id): ?>selected<?php endif; ?>><?php echo $val['room_num']; ?></option>
                            <?php endif; endforeach; endif; else: echo "" ;endif; endif; ?>
                        </select>
            ...
            <table class="layui-table">
                ...
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td><?php echo $val['phone']!='0'?$val['phone'] : '';; ?></td>
