<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"../application/index/tpl/assess\index.html";i:1549108882;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\header.html";i:1548765601;s:69:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\menu.html";i:1548765601;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\footer.html";i:1548765601;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div style="padding: 15px;">
        ...
        <div style='margin-top:20px;' class='clearfix'>
            <div style='margin-bottom:20px;' class='nav-tab-box p-l'>
                <span class="tab-item on"><a  href="<?php echo url('assess/index'); ?>">学生表扬管理</a></span>
                <span class="tab-item"><a  href="<?php echo url('assess/punishment'); ?>">学生违纪管理</a></span>
            </div>
        </div>
        ...
        <div class='c-table-box'>
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td class="open" style="cursor:pointer" data-value="<?php echo $val['remark']; ?>"><?php echo $val['remarks']; ?></td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
            </table>
...
<script>
    ...
    $(document).on('click','.js-save',function(){
        ...
        if(data){
            ...
            $.post("<?php echo url('assess/savePraise'); ?>",data,function(res){
                if(res.status == 1)
                {
