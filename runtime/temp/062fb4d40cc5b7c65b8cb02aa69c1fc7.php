<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"../application/index/tpl/honorable\index.html";i:1548765601;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\header.html";i:1548765601;s:69:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\menu.html";i:1548765601;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\footer.html";i:1548765601;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-body">
    ...
    <div style="padding: 15px;">
        ...
        <div class='search-box'>
            <div class="ipt-box">
                <form  action="<?php echo url('honorable/index'); ?>" method='post'>
        ...
        <div style='margin-top:20px;' class='clearfix'>
            <div style='margin-bottom:20px;' class='nav-tab-box p-l'>
                <span class="tab-item on"><a  href="<?php echo url('honorable/index'); ?>">贵重物品出楼登记</a></span>
            </div>
        </div>
        ...
        <div class='c-table-box'>
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td><?php echo date('Y-m-d H:i',$val['moveout_date']); ?></td>
...
<script>
    ...
    $(document).on('click','.js-save',function(){
        ...
        if(data){
            ...
            $.post("<?php echo url('honorable/saveLog'); ?>",data,function(res){
                if(res.status == 1)
                {
