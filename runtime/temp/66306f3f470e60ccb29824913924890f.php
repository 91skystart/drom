<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"../application/index/tpl/dmbuildmanage\index.html";i:1548765601;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\header.html";i:1548765601;s:69:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\menu.html";i:1548765601;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\footer.html";i:1548765601;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
        ...
        <div class='search-box'>
          <div class="ipt-box">
              <form  action="<?php echo url('Dmbuildmanage/index'); ?>" method='post'>
                  <input placeholder="请输入姓名"  name="name" value="<?php echo $name; ?>" class='search-ipt' type="text">
        ...
        <div style='margin-top:20px;' class='clearfix'>
                <div style='margin-bottom:20px;' class='nav-tab-box p-l'>
                    <span class='tab-item on'><a  href="<?php echo url('Dmbuildmanage/index'); ?>">添加人员</a></span>
                    <span class='tab-item'><a   href="<?php echo url('Dmbuildmanage/edit'); ?>">编辑人员</a></span>
                </div>
                <div class='p-r'>
                    <form id="search_from" action="<?php echo url('Dmbuildmanage/index'); ?>" method='post'>
                        <input placeholder="工号" name="job_num" value="<?php echo $job_num; ?>" class="ipt ipt-xs">
                        ...
                        <select style='margin:0 10px;' class='ipt-xs' name="build_id">
                            <option value="">请选择</option>
                            <?php if(!empty($build_id)): if(is_array($build) || $build instanceof \think\Collection || $build instanceof \think\Paginator): $i = 0; $__LIST__ = $build;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
...
<script>
    ...
    $(document).on('click','.add',function(){
        ...
        if(data){
            $.post("<?php echo url('Dmbuildmanage/insert'); ?>",data,function(res){
                if(res.status == 1){
