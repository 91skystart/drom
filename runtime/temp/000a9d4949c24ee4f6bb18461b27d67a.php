<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"../application/index/tpl/dmfloor\index.html";i:1549111428;s:55:"D:\wwwroot\dorm\application\index\tpl\index\header.html";i:1548402963;s:53:"D:\wwwroot\dorm\application\index\tpl\index\menu.html";i:1545785666;s:55:"D:\wwwroot\dorm\application\index\tpl\index\footer.html";i:1543992410;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form name='form2' id="form2" encrypt="'multipart/form-data'">
        <div class='class-import-box-layer c-layer-padding'>
            <p style='padding:25px 10px;'>
                <span>下载导入模板：</span>
                <a href="/static/楼层管理.xls">楼层管理.xls</a>
            </p>
...
<script>
    ...
    $('.inp').click(function(){
        layer.open({
            ...
            success:function(){
                $("#file_11").on("change",function(){
                    ...
                    $.ajax({
                        url: "<?php echo url('index/dmfloor/importdmbuild'); ?>",
                        type: 'post',
                        data: formData,
                        dataType: 'json',
                        processData:false,
        ...
        $('.import_btn').on('click', function(){
            $.post("<?php echo url('index/dmfloor/imfile'); ?>", {'up_path': $(".up").val()}, function(res){
                if(res.code == 0){
                    layer.msg(res.msg, {icon:2});
                }else{
                    layer.msg(res.msg, {icon: 1});
