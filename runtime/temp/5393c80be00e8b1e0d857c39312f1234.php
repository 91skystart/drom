<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"../application/index/tpl/staff\index.html";i:1548765601;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\header.html";i:1548765601;s:69:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\menu.html";i:1548765601;s:71:"C:\charles\PHPTutorial\WWW\drom\application\index\tpl\index\footer.html";i:1548765601;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div style="padding: 15px;">
        ...
        <div style='margin-top:20px;' class='clearfix'>
            <div style='margin-bottom:20px;' class='nav-tab-box p-l'>
                <span class='tab-item on'><a  href="<?php echo url('staff/index'); ?>">人员信息</a></span>
        ...
        <div style='' class='ipt-main-box'>
            <form id="editForm" action="" onsubmit="return false">
                <input type="hidden" name="ad_uid" value=""/>
                <div class="ipt-box">
                    <label for="">工号：</label>
                ...
                <button class='btn btn-info js-save'>修改</button>
            </form>
        </div>
            ...
            <table class="layui-table">
                ...
                <?php if(is_array($list['data']) || $list['data'] instanceof \think\Collection || $list['data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td class='opt-td'>
                            <a href="javascript:void(0)" data-id="<?php echo $val['ad_uid']; ?>" data-num="<?php echo $val['ad_num']; ?>" class="js-del">删除</a>
                            <a href="javascript:void(0)" data-id="<?php echo $val['ad_uid']; ?>" class="js-edit">编辑</a>
                        </td>
                    </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
...
<script>
    ...
    $(document).on('click','.js-save',function(){
        ...
        var id = $("#editForm input[name='ad_uid']").val();
        if ( !id )
        {
            layer.msg('请选择需要修改的员工', {icon: 2});
            return;
        }
